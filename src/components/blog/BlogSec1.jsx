                ...
                <div className="list-blog">
                    {
                        data.slice(4,8).map(idx=> (
                            <div key={idx.id} className="widget-blog-1">
                                ...
                                <p>{idx.text}</p>
                                <div className="widget-button-underline"><Link to="blog-detail.html">Read More</Link></div>
                                </div>
                            </div>
                        ))
                    }
                    ...
                    <div className="categories-wrap">
                        {
                            data.slice(0,4).map(idx=> (
                                <div key={idx.id} className="categories-item"><Link to="blog-grid.html">{idx.cate}</Link></div>
                            ))
                        }
                    ...
                    <div className="recent-post-wrap">
                        {
                            data.slice(4,7).map(idx => (
                                <div key={idx.id} className="widget-blog-1">
                                    ...
                                    <div className="text"><Link to="blog-detail.html">{idx.title}</Link></div>
                                    </div>
                                </div>
                            ))
                        }
                    ...
                    <div className="widget-popular-tags-wrap">
                        {
                            data.slice(0,8).map(idx=> (
                                <span key={idx.id} className="widget-popular-tags-item"><Link to="blog-grid.html">{idx.cate}</Link></span>
                            ))
                        }
                    </div>
                </div>
