    ...
    return (
        <section>
            ...
            <div className="row">
                ...
                <div className="col-lg-9 tf-tab">
                    <div className="wd-meta-select-job">

                        <div className="wd-findjob-filer">
                        <div className="group-select-display">
                            <div className="inner menu-tab">
                            <a className="btn-display current active"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="16"
                                    ...
                                    data.map(idx => (
                                        <div className="features-job cl3">
                                            ...
                                            <div className="job-footer-right">
                                                ...
                                                <p>{idx.price}<span className="year">/year</span></p>
                                                </div>
                                                <p className="days">{idx.apply}</p>
                                            </div>
                                            </div>
                                            <Link to="jobs-single.html" className="jobtex-link-item" tabIndex="0"></Link>
                                        </div>
                                    ))
                                } */}
