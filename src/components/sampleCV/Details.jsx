                ...
                <div className="tf-container">
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="wd-cv-item">
                                ...
                                <div className="content-left">
                                    ...
                                    <img src={require ('../../assets/images/review/cv-avt.jpg')} alt="images" />
                                    </div>
                                    <h6>tools</h6>
                        ...
                        <div className="cv-form-details po-sticky">
                            ...
                            <li><div className="category">Job</div><div className="detail">UI UX Designer</div></li>
                            <li><div className="category">File</div><div className="detail">PDF</div></li>
                            <li><div className="category">Stype</div><div className="detail">Minimal, Create</div></li>
                            <li><div className="category">Language</div><div className="detail">English</div></li>
                            </ul>
                            <p>Suitable for 1000+ companies</p>
                            <ul className="list-partner">
                            <li><Link to="#"><img src={require ('../../assets/images/logo-company/cty13.png')} alt="images" /></Link></li>
                            <li><Link to="#"><img src={require ('../../assets/images/logo-company/cty14.png')} alt="images" /></Link></li>
                            <li><Link to="#"><img src={require ('../../assets/images/logo-company/cty11.png')} alt="images" /></Link></li>
                            <li><Link to="#"><img src={require ('../../assets/images/logo-company/cty16.png')} alt="images" /></Link></li>
                            <li><Link to="#"><img src={require ('../../assets/images/logo-company/cty15.png')} alt="images" /></Link></li>
                            <li><Link to="#"><img src={require ('../../assets/images/logo-company/cty10.png')} alt="images" /></Link></li>
                            <li><Link to="#"><img src={require ('../../assets/images/logo-company/cty10.png')} alt="images" /></Link></li>
                            </ul>
