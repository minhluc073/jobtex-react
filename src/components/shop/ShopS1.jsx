                ...
                <div className="row">
                    ...
                    <div className="content-tab">
                        ...
                        <div className="group-col-3">
                            {
                                data.map(idx => (
                                    <div key={idx.id} className="employer-block style-3 cl3 wd-shop stc">
                                        <div className="inner-box">
                                            <Link to="#">
                                            <div className="product-main-images">
                                                <img className="logo-company" src={idx.img1} alt="jobtex" />
                                            </div>
                                            <div className="product-hover-images">
                                                <img className="logo-company" src={idx.img2} alt="jobtex" />
                                            </div>
                                            </Link>
                                            ...
                                            <li><Link to="#" className="wish-list" data-tooltip="Add to wish list"><i className="icon-heart"></i></Link>
                                            </li>
                                            <li><Link to="#" className="compare" data-tooltip="Compare"><svg xmlns="http://www.w3.org/2000/svg"
                                                    version="1.1" xlink="http://www.w3.org/1999/xlink"
                                                    svgjs="http://svgjs.com/svgjs" width="512" height="512" x="0" y="0"
                                                    viewBox="0 0 512 512"  space="preserve"
                                                    className="">
                                                    <g
                                                    transform="matrix(6.123233995736766e-17,-1,1,6.123233995736766e-17,0.0009007453918172814,511.99912214279175)">
                                                    <path fillRule="evenodd"
                                                        ...
                                                        clipRule="evenodd" fill="#000000" data-original="#000000" className=""></path>
                                                    </g>
                                                </svg></Link></li>
                                            <li><Link to="#" className="view" data-tooltip="Quick view"><svg xmlns="http://www.w3.org/2000/svg"
                                                    version="1.1" xlink="http://www.w3.org/1999/xlink"
                                                    svgjs="http://svgjs.com/svgjs" width="512" height="512" x="0" y="0"
                                                    viewBox="0 0 24 24"  space="preserve" className="">
                                                    <g>
                                                    <g data-name="Layer 2">
                                                        <path
                                            ...
                                            <Link to="shop-details.html" className="btn-employer">add to cart</Link>
                                            </div>
                                        </div>
                                    </div>
                                ))
