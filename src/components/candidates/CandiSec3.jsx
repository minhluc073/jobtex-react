                ...
                <div className="row">
                    ...
                    <div className="wd-meta-select-job">
                        ...
                        <div className="group-select-display">
                            ...
                            <a className="btn-display current"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="16"
                                viewBox="0 0 17 16" fill="none">
                                <path
                    ...
                    <div className="content-tab no-scroll">
                        <div className="inner">
                            {
                                data.map(idx => (
                                    <div key={idx.id} className="features-job candidate-layout wd-thum-career">
                                        <div className="job-archive-header">
                                        <div className="career-header-left">
                                            <img src={idx.avt} alt="jobtex"
                                            className="thumb" />
                                        ...
                                        <div className="career-header-right">
                                            ...
                                            <Link to="candidate-single.html" className="tf-btn">View Profile</Link>
                                        </div>
                                        </div>
                        ...
                        {/* <div className="inner">
                            <div className="group-col-2">
                                {
                                    data.map(idx => (
                                        <div key={idx.id} className="features-job wd-thum-career style-2 cl2 mb1">
                                            <div className="job-archive-header">
                                                <div className="career-header-left">
