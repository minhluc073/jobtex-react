            ...
            <section className="wrapper-author-page-title stc2 ">
                    <div className="tf-container">
                        ...
                        <div className="author-archive-header">
                            <img src={require ('../assets/images/user/avatar/avt-author-1.jpg')} alt="jobtex" className="logo-company" />
                            <div className="content">
                            <Link to="#" className="tag-head">Available now</Link>
                            <h4><Link to="#">Computer Systems Analyst</Link></h4>
                            <h3><Link to="#">Maverick Nguyen</Link> <span className="icon-bolt"></span></h3>
                            <ul className="author-list">
                                <li className="tag"> Blender </li>
                                <li className="tag"> Sketch </li>
                                <li className="tag"> Adobe XD </li>
                                <li className="tag"> Figma </li>
                                <li className="map"> <span className="icon-map-pin"></span>&nbsp; Tokyo, Japan </li>
                                <li className="price"><span className="icon-dolar1"></span>&nbsp; $300/day </li>
                            </ul>
                            </div>
                        </div>
                ...
                <div className="tf-container">
                    ...
                    <div className="col-lg-8">
                        ...
                        <div className="content-tab">
                            ...
                            <p className="mg-39">Deloitte's Green Dot Agency is looking to add a Lead User Experience Designer to our
                            ...
                            <div className="group-infor">
                                ...
                                <div className="inner">
                                <div className="sub-heading">TB Course <span>2019 - 2021</span></div>
                            ...
                            <div className="group-skill group-col-2">
                                ...
                                <div className="wd-cv-skill">
                                    <div className="progress-item">
                                    <div className="progress-heading">
                                        <div className="heading-progress">Ilustration</div>
                                        <div className="donat-bg" data-percent="90%">
                                        <div className="custom-donat"></div>
                                        </div>
                                    </div>
                            ...
                            <div className="form-candidate">
                                ...
                                <div className="group-input">
                                    ...
                                    <div className="ip">
                                    <label>Name</label>
                                    <input type="text" placeholder="Name" value="Tony Nguyen |" />
                                    </div>
                                </div>
                    ...
                    <div className="col-lg-4 ">
                        ...
                        <ul className="list-infor">
                            ...
                            <li><div className="category">Offered Salary</div><div className="detail">$2500/Month</div></li>
                            <li><div className="category">Experience time</div><div className="detail">5 Years</div></li>
                            <li><div className="category">Language</div><div className="detail">English, Vietnamese </div></li>
                            <li><div className="category">Age</div><div className="detail">26 Years Old</div></li>
                            <li><div className="category">Qualification</div><div className="detail">Master Degree</div></li>
                        </ul>
                        ...
                        <Link to="#" className="btn-dowload"><i className="icon-download"></i> Download CV</Link>
                        </div>
                    </div>
                    </div>
                </div>
