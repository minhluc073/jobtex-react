            ...
            <section className="inner-employer-section">
                ...
                <div className="row">
                    ...
                    <div className="wd-job-author stc-em2 form-sticky fixed-space">
                        ...
                        <img src={require ('../assets/images/logo-company/cty4.png')} alt="jobtex" className="logo-company" />
                        <div className="content">
                            <h3><Link to="#">Avitex Agency</Link><span className="icon-bolt"></span></h3>
                        ...
                        <div className="inner-content">
                            ...
                            <ul className="thumb-menu menu-tab2">
                                <li className="ct-tab2"> <a className="lightbox-gallery" href="images/review/thumbv4.jpg"><img
                                    src={require ('../assets/images/review/thumbv4.jpg')} alt="images" /></a> </li>
                                <li className="ct-tab2"> <a className="lightbox-gallery" href="images/review/thumbv1.jpg"><img
                                    src={require ('../assets/images/review/thumbv1.jpg')} alt="images" /></a></li>
                                <li className="ct-tab2"><a className="lightbox-gallery" href="images/review/thumbv2.jpg"><img
                                    src={require ('../assets/images/review/thumbv2.jpg')} alt="images" /></a></li>
                            </ul>
                            </div>
                            ...
                            <div className="features-job mg-bt-0">
                                ...
                                <div className="inner-box">
                                    ...
                                    <img src={require ('../assets/images/logo-company/cty4.png')} alt="jobtex" />
                                    </div>
                                    <div className="box-content">
                                    <h4>
                                        <Link to="employers-single.html">Tamari Law Group LLC</Link>
                                    </h4>
                                    <h3>
                                        <Link to="employers-single.html">HR Administration</Link>
                            ...
                            <ul className="client-review">
                                ...
                                <div className="content">
                                    ...
                                    <div className="avatar">
                                        <div className="avt">
                                        <img src={require ('../assets/images/user/avatar/img-5.jpg')} alt="images" />
                                        </div>
                                        <div className="infor">
                                    ...
                                    <Link to="#" className="btn-like">Was this helpful? <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div className="content">
                                    ...
                                    <div className="avatar">
                                        <div className="avt">
                                        <img src={require ('../assets/images/user/avatar/image-04.jpg')} alt="images" />
                                        </div>
                                        <div className="infor">
                    ...
                    <div className="cv-form-details st2 po-sticky">
                        ...
                        <li>
                            ...
                            <div className="detail"><Link to="#">avitex.vn</Link></div>
                        </li>
                        <li>
