            ...
            <section className="shop-deltail-section">
                ...
                <div className="row">
                    ...
                    <div className="shop-details group-col-2">
                        ...
                        <img src={require ('../assets/images/review/shop.jpg')} alt="images" />
                        </div>
                        ...
                        <p className="des">Are you a User Experience Designer with a track record of delivering intuitive digital
                            experiences that drive results? Are you a strategic storyteller and systems thinker who can concept and
                            craft smart, world-class campaigns across a variety of mediums?</p>
                        <div className="group-category">
                            <div className="sku"> <span>SKU:</span> A515-56-36UT</div>
                ...
                <div className="row">
                    ...
                    <div className="group-tab">
                        <ul className="menu-tab shop-detail-tab">
                        <li className="ct-tab active">Review</li>
                        <li className="ct-tab">Description</li>
                        </ul>
                    </div>
                    <div className="content-tab">
                        ...
                        <div className="job-rating st2">
                            ...
                            <Link to="#" className="btn">Write a review</Link>
                            </div>
                            ...
                            <li className="client-item">
                                ...
                                <div className="top-content">
                                    ...
                                    <div className="avt">
                                        <img src={require ('../assets/images/review/avt2.jpg')} alt="images" />
                                    </div>
                                    <div className="infor">
                                        <h5><Link to="#">Ariel Houessou</Link><svg xmlns="http://www.w3.org/2000/svg" width="21"
                                        ...
                                        <Link to="#" className="date">August 13, 2023</Link>
                                        <ul className="list-star">
                                        <li className="icon-star-full"></li>
                                        <li className="icon-star-full"></li>
                                        <li className="icon-star-full"></li>
                                ...
                                <Link to="#" className="btn-like">Was this helpful? <svg xmlns="http://www.w3.org/2000/svg" width="17"
                            ...
                            <li className="client-item">
                                ...
                                <div className="top-content">
                                    <div className="avatar">
                                    <div className="avt">
                                        <img src={require ('../assets/images/review/avt3.jpg')} alt="images" />
                                    </div>
                                    <div className="infor">
                                        <h5><Link to="#">Antony Bessan</Link><svg xmlns="http://www.w3.org/2000/svg" width="21"
                                            height="20" viewBox="0 0 21 20" fill="none">
                                            <path fillRule="evenodd" clipRule="evenodd"
                                            d="M0.5 10C0.5 4.47715 4.97715 0 10.5 0C16.0228 0 20.5 4.47715 20.5 10C20.5 15.5228 16.0228 20 10.5 20C4.97715 20 0.5 15.5228 0.5 10Z"
                                            fill="#37B853" />
                            ...
                            <li className="client-item">
                                ...
                                <div className="top-content">
                                    <div className="avatar">
                                    <div className="avt">
                                        <img src={require ('../assets/images/review/avt.jpg')} alt="images" />
                                    </div>
                                    <div className="infor">
                                        <h5><Link to="#">Jean Paul Sessou</Link><svg xmlns="http://www.w3.org/2000/svg" width="21"
                                            height="20" viewBox="0 0 21 20" fill="none">
                                            <path fillRule="evenodd" clipRule="evenodd"
                                            d="M0.5 10C0.5 4.47715 4.97715 0 10.5 0C16.0228 0 20.5 4.47715 20.5 10C20.5 15.5228 16.0228 20 10.5 20C4.97715 20 0.5 15.5228 0.5 10Z"
                                            fill="#37B853" />
                            ...
                            <Link to="#" className="btn-load">See more reviews (719)</Link>
                            ...
                            <form method="post">
                                ...
                                <div className="ip">
                                    <label>Email</label>
                                    <input type="email" placeholder="Email" value="jobtex@mail.com" />
                                </div>
                                </div>
                                <div className="group-ant-choice st">
                                <div className="sub-ip"><input type="checkbox" />Save your name, email for the next time review</div>
                                </div>
                        ...
                        <div className="shop-description">
                            ...
                            <p>From FOX News anchor and author Harris Faulkner comes a collection of powerful, true-life stories of
                            resilience, healing, rescue, and protection.
                            We need reminders of God’s power now more than ever.</p>
                            <p>We often think about prayer as a wish list, with God as Santa Claus. The reality is that the power of
                            prayer reminds us not only how small we are, but also how big God is. Prayer is hope put into action.
                            And prayer works.</p>
                            <p>From the aftermath of the devastating earthquake in Haiti to the theater shooting in Aurora,
                            Colorado, believers testify to how God inspired hope even when all seemed lost.</p>
                            <p>Two teenagers who were saved from treacherous seas by a vessel named Amen now give thanks for the
                            rescue that changed their lives. A woman’s near-death experience with COVID-19 turned out to be the
                            crisis freeing her from despair. Others speak to how prayer helped them navigate family trauma,
                            overcome abuse, and cope with mental illness and depression. Historical accounts of miracles testify
                            to God’s power throughout time, and Faulkner recounts the role of faith and prayer in her own life and
                            the life of her father.</p>
                            <p>Along with these stories of God’s presence, the book includes an exclusive packet of newly written
                            prayers. Created to reflect the current times, this prayer booklet will provide a road map for putting
                            the lessons of these stories into action.
                            Faith Still Moves Mountains reminds us that God’s light always shines through the darkness. Through
                            these testimonies, we learn prayer isn’t just a ritual, it’s a vital spiritual strategy in a world
                            that wants us to give up the fight.</p>
                        </div>
                        </div>
                    </div>
                    </div>
