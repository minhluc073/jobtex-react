    ...
    return (
        <div>
            ...
            <section className="single-job-thumb st2">
                    <img src={require ('../assets/images/review/singlejob.jpg')} alt="images" />
            </section>
                ...
                <div className="row">
                    <div className="col-lg-8">
                        <div className="wd-job-author2 form-sticky fixed-space">
                            ...
                            <div className="thumb">
                                <img src={require ('../assets/images/logo-company/cty4.png')} alt="logo" />
                            </div>
                            <div className="content">
                                <Link to="#" className="category">Rockstar Games New York</Link>
                                <h6><Link to="#">Senior UI/UX Designer <span className="icon-bolt"></span></Link></h6>
                            ...
                            <div className="top">
                                <Link to="#" className="share"><i className="icon-share2"></i></Link>
                                <Link to="#" className="wishlist"><i className="icon-heart"></i></Link>
                    ...
                    <article className="job-article tf-tab single-job">
                        ...
                        <div className="inner-content">
                            ...
                            <Link to="#" className="frag-btn"> <svg xmlns="http://www.w3.org/2000/svg" width="14" height="15"
                            ...
                            <div className="content-tab2">
                                <div className="inner">
                                <div className="thumb">
                                    <img src={require ('../assets/images/review/thumbv3.jpg')} alt="images" />
                                    <Link to="https://www.youtube.com/watch?v=MLpWrANjFbI" className="lightbox-image">
                            ...
                            <ul className="thumb-menu menu-tab2">
                                <li className="ct-tab2"> <a className="lightbox-gallery" href="images/review/thumbv4.jpg"><img src={require ('../assets/images/review/thumbv4.jpg')} alt="images" /></a> </li>
                                <li className="ct-tab2"> <a className="lightbox-gallery" href="images/review/thumbv1.jpg"><img src={require ('../assets/images/review/thumbv1.jpg')} alt="images" /></a></li>
                                <li className="ct-tab2"><a className="lightbox-gallery" href="images/review/thumbv2.jpg"><img src={require ('../assets/images/review/thumbv2.jpg')} alt="images" /></a></li>
                            </ul>
                            </div>
                            ...
                            <ul className="client-review">
                                ...
                                <div className="content">
                                    ...
                                    <div className="avatar">
                                        ...
                                        <div className="infor">
                                        <h5><Link to="#">Dianne Russell</Link><svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                                    ...
                                    <Link to="#" className="btn-like">Was this helpful? <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
                            ...
                            <Link to="find-jobs-list.html" className="btn-load">See more reviews (719)</Link>
                            </div>
                            ...
                            <div className="features-job mg-bt-0">
                                ...
                                <div className="inner-box">
                                    ...
                                    <img src={require ('../assets/images/logo-company/cty2.png')}
                                        alt="jobtex" />
                                    </div>
                                    <div className="box-content">
                                    <h4>
                                        <Link to="jobs-single.html">Tamari Law Group LLC</Link>
                                    </h4>
                                    <h3>
                                        <Link to="jobs-single.html">HR Administration</Link>
                            ...
                            <div className="features-job mg-bt-0">
                                ...
                                <div className="inner-box">
                                    <div className="logo-company">
                                    <img src={require ('../assets/images/logo-company/cty7.png')}
                                        alt="jobtex" />
                                    </div>
                                    <div className="box-content">
                                    <h4>
                            ...
                            <div className="features-job mg-bt-0">
                                ...
                                <div className="inner-box">
                                    <div className="logo-company">
                                    <img src={require ('../assets/images/logo-company/cty8.png')}
                                        alt="jobtex" />
                                    </div>
                                    <div className="box-content">
                                    <h4>
                    ...
                    <div className="cv-form-details st2  po-sticky">
                        ...
                        <li><div className="category">Website</div><div className="detail"><Link to="#">avitex.vn</Link></div></li>
