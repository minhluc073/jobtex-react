                        ...
                        <div className="wrap-blog-detail blog-detail-01 blog-detail-side-bar-content">
                            <div className="widget-blog-1 style-1">
                                <div className="content">
                                    ...
                                    <h3 className="main-heading">Where to grow your business as a photographer: site or social media?</h3>
                                    <ul className="meta">
                                    <li className="author"><span>by</span>Avitex</li>
                                    <li className="time"><span className="icon-calendar"></span> 2 days ago</li>
                                    </ul>
                                </div>
                            </div>
